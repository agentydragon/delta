...
";
        ...
        _test_env_var_overrides_git_config_generic(
            ...
            &|opt: Opt| assert!(opt.side_by_side.is_some() && opt.side_by_side.as_deref() != Some("never") && opt.side_by_side.as_deref() != Some("false")),
            &|opt: Opt| assert!(opt.side_by_side.is_none() || opt.side_by_side.as_deref() == Some("never") || opt.side_by_side.as_deref() == Some("false")),
        );
    }
...
";
        ...
        assert!(opt.side_by_side.is_none() || opt.side_by_side.as_deref() == Some("never") || opt.side_by_side.as_deref() == Some("false"));
